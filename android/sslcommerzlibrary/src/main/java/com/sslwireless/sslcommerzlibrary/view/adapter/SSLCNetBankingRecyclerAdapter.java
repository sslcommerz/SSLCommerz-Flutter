...
public class SSLCNetBankingRecyclerAdapter extends RecyclerView.Adapter<SSLCNetBankingRecyclerAdapter.MyViewHolder> {
    ...
    public SSLCNetBankingRecyclerAdapter(Context context, List<SSLCSdkMainResponseModel.Desc> data) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.custom_net_banking_recycler_sslc, parent, false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        if (!defaultChecker && mTaskInfo.get(position).getAutoselect() != null && mTaskInfo.get(position).getAutoselect().equals("1")) {
            defaultChecker = true;
...
//                            Log.e(TAG, "onClick: " + datum.getRedirectGatewayURL());
    ...
    class MyViewHolder extends RecyclerView.ViewHolder /*implements View.OnClickListener*/ {
        ...
        public void onClick(View v) {
            if (clickListener != null) {
                clickListener.itemClicked(v, getPosition(), mTaskInfo);
            }
        }*/
    }
}